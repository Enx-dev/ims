...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-primary-300",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "border border-primary-200 bg-transparent shadow-sm hover:bg-primary-100 hover:text-primary-900 dark:border-primary-800 dark:hover:bg-primary-800 dark:hover:text-primary-50",
        secondary:
